...
// PATCHED for nex: upstream hardcodes `defined(__wasi__)` as "no exceptions",
// but nex's wasi target supports wasm-exceptions (-fwasm-exceptions).
// Probe __cpp_exceptions / __EXCEPTIONS / _CPPUNWIND only; let __wasi__ pass.
