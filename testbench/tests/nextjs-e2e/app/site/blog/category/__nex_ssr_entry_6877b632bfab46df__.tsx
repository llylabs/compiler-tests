...
globalThis.__nex_request_headers = {"host":"127.0.0.1:44249","connection":"keep-alive","accept":"*/*","accept-language":"*","sec-fetch-mode":"cors","user-agent":"node","accept-encoding":"gzip, deflate","x-lly-nonce":"pyVnOtmYFB4Fp2VIbzO0Xw"};
...
// Mid-level layout Ã¢ÂÂ wraps site/* pages with a chrome
function __Layout1__({ children }) {
  return (
    <section className="site-wrap">
      <header><a href="/">Home</a> ÃÂ· <a href="/site/blog/category">Blog</a></header>
      <main>{children}</main>
      <footer>Site footer</footer>
    </section>
  );
}
// Inner layout Ã¢ÂÂ wraps site/blog/* pages
function __Layout2__({ children }) {
  return (
...
// Deep nested page Ã¢ÂÂ root layout Ã¢ÂÂ site layout Ã¢ÂÂ blog layout Ã¢ÂÂ page
function __Page__() {
  return (
    <div>
      <h1>Category Index</h1>
      <p>Three layouts above me</p>
    </div>
  );
}
var __params = {};
...
function __render_main() {
    ...
    if (typeof __layout_metadata_1 !== 'undefined' && __layout_metadata_1) Object.assign(__meta, __layout_metadata_1);
    if (typeof __layout_metadata_2 !== 'undefined' && __layout_metadata_2) Object.assign(__meta, __layout_metadata_2);
    ...
    try {
        __wrapped = __Layout2__({ children: __wrapped });
    } catch (__layout_err) {
        console.log("[render] layout 2 threw: " + __layout_err);
    }
    try {
        __wrapped = __Layout1__({ children: __wrapped });
    } catch (__layout_err) {
        console.log("[render] layout 1 threw: " + __layout_err);
    }
    try {
