...
globalThis.__nex_request_headers = {"host":"127.0.0.1:37973","connection":"keep-alive","accept":"*/*","accept-language":"*","sec-fetch-mode":"cors","user-agent":"node","accept-encoding":"gzip, deflate","x-lly-nonce":"6V-rrrTdCROFRx756qCrHg"};
...
function __page_generateMetadata({ params, searchParams }) {
...
function __Page__({ searchParams }) {
  const sp = searchParams || {};
  return (
    <div>
      <h1>With Meta</h1>
...
function __render_main() {
    ...
    try { var __gm_p = __page_generateMetadata({ params: __params, searchParams: __searchParams }); if (__gm_p) Object.assign(__meta, __gm_p); } catch (e) {}
    var __viewport = {};
