...
globalThis.__nex_request_headers = {"host":"127.0.0.1:37973","connection":"keep-alive","accept":"*/*","accept-language":"*","sec-fetch-mode":"cors","user-agent":"node","accept-encoding":"gzip, deflate","x-lly-nonce":"K7nfI5oyggE-Ngi1xKssyw"};
...
const __page_metadata_viewport = {
  width: 'device-width',
  initialScale: 1,
  maximumScale: 2,
  userScalable: true,
...
function __render_main() {
    ...
    var __viewport = {};
    if (typeof __page_metadata_viewport !== 'undefined' && __page_metadata_viewport) Object.assign(__viewport, __page_metadata_viewport);
