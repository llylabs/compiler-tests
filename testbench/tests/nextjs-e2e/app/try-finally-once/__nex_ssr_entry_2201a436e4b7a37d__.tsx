...
globalThis.__nex_request_headers = {"host":"127.0.0.1:37499","connection":"keep-alive","accept":"*/*","accept-language":"*","sec-fetch-mode":"cors","user-agent":"node","accept-encoding":"gzip, deflate","x-lly-nonce":"_3o2UBSlhImQJmRD0VIy_w"};
...
// flow, counter should be 1 Ã¢ÂÂ not 2 (duplication bug would show 2 if
// finally somehow ran twice).
async function __Page__() {
  var counter = 0;
  try {
    try {
    ...
    // outer catch Ã¢ÂÂ shouldn't fire
  }
  return (
    <div>
