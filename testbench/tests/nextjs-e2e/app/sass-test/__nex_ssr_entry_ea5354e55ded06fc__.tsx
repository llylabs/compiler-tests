...
globalThis.__nex_request_headers = {"host":"127.0.0.1:40409","connection":"keep-alive","accept":"*/*","accept-language":"*","sec-fetch-mode":"cors","user-agent":"node","accept-encoding":"gzip, deflate","x-lly-nonce":"mv3o2LY_LzU8Jd4qeyONJw"};
...
import styles from '/home/leon/prod/bench/testbench/tests/nextjs-e2e/app/sass-test/page.module.scss';
...
try { if (typeof submitName === 'function') submitName.__lly_action_ref = 'MMfJvoc5KPZ-sxcetK6scA'; } catch (__e) {}
try { if (typeof createPost === 'function') createPost.__lly_action_ref = 'TGvqZ83P23eutbxD--fHUQ'; } catch (__e) {}
try { if (typeof deletePost === 'function') deletePost.__lly_action_ref = 'f53FAzc6Zaol3Y7gKMkeUQ'; } catch (__e) {}
try { if (typeof addItem === 'function') addItem.__lly_action_ref = 'DmrZQ5-lH99B-_eIHbyHbg'; } catch (__e) {}
try { if (typeof noop === 'function') noop.__lly_action_ref = 'k8Z7_4bhZQN0l1T4T4W3Eg'; } catch (__e) {}
try { if (typeof inlineSubmit === 'function') inlineSubmit.__lly_action_ref = 'GJkqYtMa6nnEvvWamH0pIA'; } catch (__e) {}
