...
function GET()    { return NextResponse.json({ m: "GET" }); }
function POST()   { return NextResponse.json({ m: "POST" }); }
function PUT()    { return NextResponse.json({ m: "PUT" }); }
function DELETE() { return NextResponse.json({ m: "DELETE" }); }
function PATCH()  { return NextResponse.json({ m: "PATCH" }); }
var __method = "POST";
var __body = "";
var __url_full = "http://localhost/api/multi-method";
var __pathname = "/api/multi-method";
var __search_raw = "";
var __sp_entries = [];
var __req_headers = [];
...
__req_headers.push(["x-lly-nonce", "_IA7qQVBxFg-TwPhpDnKBQ"]);
var __req_cookies = [];
